...
import { Plus, X, Sparkles, Wrench, Zap, Truck, Home, Briefcase, Pencil, Trash2, Settings } from "lucide-react";
    ...
    <div className="space-y-6 relative">
      ...
      {managingCategory && (
        <ManageServicesModal
          ...
          initialServices={services.filter((s: any) => s.category_id === managingCategory.id)}
