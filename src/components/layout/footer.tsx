            ...
            <div className="flex space-x-3">
              {[
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-muted hover:bg-owl-violet hover:text-white flex items-center justify-center text-xs font-bold text-muted-foreground transition-all hover:scale-110"
                >
                  {social.icon}
                </a>
              ))}
